...
namespace D2DPaint
{
    ...
    public partial class Paint2DForm : Form
    {
        ...
        private readonly ColorF WhiteBackgroundColor = new ColorF(Colors.White);
        ...
        RenderTargetProperties renderProps = new RenderTargetProperties
        {
            ...
            Type = RenderTargetType.Software // Software type is required to allow resource 
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == saveDlg.ShowDialog())
            {
                ...
                WICBitmap wicBitmap = wicFactory.CreateWICBitmap(
                    size.Width,
                    size.Height,
                    PixelFormats.Pf32bppBGR, 
                    BitmapCreateCacheOption.CacheOnLoad);

                D2DBitmap d2dBitmap = renderTarget.CreateBitmap(size, new BitmapProperties(new PixelFormat(Microsoft.WindowsAPICodePack.DirectX.DXGI.Format.B8G8R8A8_UNORM, AlphaMode.Ignore), renderTarget.Dpi.X, renderTarget.Dpi.Y));
