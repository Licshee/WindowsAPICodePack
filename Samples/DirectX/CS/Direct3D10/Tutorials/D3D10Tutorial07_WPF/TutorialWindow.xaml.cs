...
namespace D3D10Tutorial07_WPF
{
    ...
    public partial class TutorialWindow : Window
    {
        ...
        {
            device = D3DDevice1.CreateDeviceAndSwapChain1(host.Handle, out swapChain);
        ...
        protected void RenderScene()
        {
            if (needsResizing)
            {
                ...
                swapChain.ResizeBuffers(sd.BufferCount, (uint)host.ActualWidth, (uint)host.ActualHeight, sd.BufferDescription.Format, sd.Flags);
                SetViews();
