            ...
            If random.NextDouble() < 0.5 Then
                SyncLock sharedSyncObject
                    If sharedD2DFactory Is Nothing Then
                        ...
                        sharedWicFactory = New ImagingFactory()
...
#Region "SetRenderMode()"
        Private Sub SetRenderMode(ByVal rm As RenderModes)
            SyncLock renderSyncObject
                ...
                Dim props = New RenderTargetProperties With {.PixelFormat = New PixelFormat(Format.B8G8R8A8_UNORM, AlphaMode.Ignore), .Usage = RenderTargetUsage.GdiCompatible}
                ...
                If _renderMode = RenderModes.DCRenderTarget OrElse _renderMode = RenderModes.BitmapRenderTargetOnPaint Then
                    ...
                    _render = Nothing
                Else
                    hwndRenderTarget = d2DFactory.CreateHwndRenderTarget(props, New HwndRenderTargetProperties(Handle, size, PresentOptions.RetainContents))
                ...
                SyncLock renderSyncObject
                    If _renderMode = RenderModes.DCRenderTarget OrElse _renderMode = RenderModes.BitmapRenderTargetOnPaint Then
                        ...
                        ElseIf _renderMode = RenderModes.BitmapRenderTargetOnPaint Then
                            ...
                            dcRenderTarget.DrawBitmap(bitmapRenderTarget.GetBitmap(), 1.0F, BitmapInterpolationMode.NearestNeighbor, New RectF(0, 0, Width, Height))
        ...
        Private Sub RenderSceneInBackground()
            ...
            If _renderMode = RenderModes.HwndRenderTarget OrElse _renderMode = RenderModes.BitmapRenderTargetRealTime Then
                ...
                ElseIf _renderMode = RenderModes.BitmapRenderTargetRealTime Then
                    ...
                    hwndRenderTarget.DrawBitmap(bitmapRenderTarget.GetBitmap(), 1.0F, BitmapInterpolationMode.NearestNeighbor, New RectF(0, 0, Width, Height))
