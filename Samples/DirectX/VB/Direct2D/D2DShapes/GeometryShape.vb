...
'INSTANT VB NOTE: The variable geometry was renamed since Visual Basic does not allow class members with the same name:
		...
		Private Function RandomGeometryGroup() As Geometry
			Dim geometries = New List(Of Geometry)()
			Dim count As Integer = Random.Next(1, 5)
			For i As Integer = 0 To count - 1
				geometries.Add(RandomGeometry())
			Next i
			Dim ret As GeometryGroup = d2DFactory.CreateGeometryGroup(If(Random.NextDouble() <.5, FillMode.Winding, FillMode.Alternate), geometries)
