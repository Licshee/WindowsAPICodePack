...
'			Me.transparencyValues.SelectedIndexChanged += New System.EventHandler(Me.transparencyValues_SelectedIndexChanged)
			' 
			' transparency
			' 
...
'			Me.solidColorButton.Click += New System.EventHandler(Me.SelectColorClick)
			' 
			' colorLabel
			' 
...
'			Me.addBrushButton.Click += New System.EventHandler(Me.addBrushButton_Click)
			' 
			' brushesTabs
			' 
...
'			Me.comboBox2.SelectedIndexChanged += New System.EventHandler(Me.OpacityButtonClicked)
			' 
			' label4
			' 
...
'			Me.addBitmapBrushBotton.Click += New System.EventHandler(Me.addBitmapBrushBotton_Click)
			' 
			' button2
			' 
...
'			Me.button3.Click += New System.EventHandler(Me.LinearGradientBrushAddClicked)
			' 
			...
			Me.gammaComboBox.Items.AddRange(New Object() { "Gamma 1.0", "Gamma 2.2"})
			...
			Me.gammaComboBox.Text = "Gamma 2.2"
			' 
...
'			Me.gradiantBrushColor2Button.Click += New System.EventHandler(Me.gradiantBrushColor2Button_Click)
			' 
...
'			Me.gradiantBrushColor1button.Click += New System.EventHandler(Me.gradiantBrushColor1button_Click)
			' 
			' graidantBrushPage
			' 
...
'			Me.button4.Click += New System.EventHandler(Me.RadialGradientBrushAddClicked)
			' 
			' radialExtendCombo
			' 
			...
			Me.radialGammaCombo.Items.AddRange(New Object() { "Gamma 1.0", "Gamma 2.2"})
			...
			Me.radialGammaCombo.Text = "Gamma 2.2"
			' 
...
'			Me.SelectRadialColor2.Click += New System.EventHandler(Me.SelectRadialColor2_Click)
			' 
			' SelectRadialColor1
			' 
...
'			Me.SelectRadialColor1.Click += New System.EventHandler(Me.SelectRadialColor1_Click)
			' 
			' brushesList
			' 
...
'			Me.brushesList.SelectedIndexChanged += New System.EventHandler(Me.listBox1_SelectedIndexChanged)
			' 
			' button1
			' 
...
'			Me.button1.Click += New System.EventHandler(Me.CloseButtonClicked)
			' 
			' BrushDialog
			' 
