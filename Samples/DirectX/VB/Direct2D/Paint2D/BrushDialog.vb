...
Namespace D2DPaint
	...
	Partial Public Class BrushDialog
		Inherits Form
		Private color1 As New ColorF(Colors.Black)
		Private color2 As New ColorF(Colors.White)
        ...
        Private Sub FillBrushesListBox()
            ...
            For Each brush As Brush In parentCopy.brushes
                If TypeOf brush Is SolidColorBrush Then
                    ...
                    Me.brushesList.Items.Add(String.Format("Solid: R={0}, G={1}, B={2}, A={3}, Opacity={4}", solidBrush.Color.R, solidBrush.Color.G, solidBrush.Color.B, solidBrush.Color.A, solidBrush.Opacity))
        ...
        Private Sub gradiantBrushColor1button_Click(ByVal sender As Object, ByVal e As EventArgs) Handles gradiantBrushColor1button.Click
            ...
            If colorDialog1.ShowDialog() <> System.Windows.Forms.DialogResult.Cancel Then
                ...
                gradBrushColor1Label.Text = String.Format("R = {0}, G = {1}, B = {2}, A = {3}", color1.R, color1.G, color1.B, color1.A)
            End If
        End Sub
        ...
        Private Sub gradiantBrushColor2Button_Click(ByVal sender As Object, ByVal e As EventArgs) Handles gradiantBrushColor2Button.Click
            ...
            If colorDialog1.ShowDialog() <> System.Windows.Forms.DialogResult.Cancel Then
                ...
                gradBrushColor2Label.Text = String.Format("R = {0}, G = {1}, B = {2}, A = {3}", color2.R, color2.G, color2.B, color2.A)
            End If
        End Sub
        ...
        Private Sub LinearGradientBrushAddClicked(ByVal sender As Object, ByVal e As EventArgs) Handles button3.Click
            ...
            Dim gamma As Gamma = If(gammaComboBox.SelectedIndex > 0, CType(gammaComboBox.SelectedIndex, Gamma), Gamma.Gamma_10)
        ...
        Private Sub RadialGradientBrushAddClicked(ByVal sender As Object, ByVal e As EventArgs) Handles button4.Click
            ...
            Dim gamma As Gamma = If(radialGammaCombo.SelectedIndex > 0, CType(radialGammaCombo.SelectedIndex, Gamma), Gamma.Gamma_10)
		...
		Private Sub SelectRadialColor1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles SelectRadialColor1.Click
			...
			If colorDialog1.ShowDialog() <> System.Windows.Forms.DialogResult.Cancel Then
				...
				radialBrushColor1Label.Text = String.Format("R = {0}, G = {1}, B = {2}, A = {3}", color1.R, color1.G, color1.B, color1.A)
			End If
		End Sub
