...
Namespace D2DPaint
	...
	Partial Public Class Paint2DForm
		...
		Private ReadOnly WhiteBackgroundColor As New ColorF(Colors.White)
		Private textDialog As TextDialog
		Private bitmapDialog As OpenFileDialog

		Private currentButton As ToolStripButton = Nothing

        Private renderProps As New RenderTargetProperties(RenderTargetType.Software, New PixelFormat(DXGI.Format.B8G8R8A8_UNORM, AlphaMode.Ignore), 0, 0, RenderTargetUsage.None, Direct3D.FeatureLevel.Default)
		...
		Private Sub CreateDeviceResources()
			...
			If renderTarget Is Nothing Then
				...
				brushes.Add(renderTarget.CreateSolidColorBrush(New ColorF(Colors.Black)))
				currentBrushIndex = 0
			End If
		End Sub
		#End Region
        ...
        Private Sub saveButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles saveButton.Click
            ...
            If saveDlg.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                Dim wicBitmap = wicFactory.CreateWICBitmap(size.Width, size.Height, PixelFormats.Pf32bppBGR, BitmapCreateCacheOption.CacheOnLoad)

                Dim d2dBitmap = renderTarget.CreateBitmap(size, New BitmapProperties(New PixelFormat(Microsoft.WindowsAPICodePack.DirectX.DXGI.Format.B8G8R8A8_UNORM, AlphaMode.Ignore), renderTarget.Dpi.X, renderTarget.Dpi.Y))
