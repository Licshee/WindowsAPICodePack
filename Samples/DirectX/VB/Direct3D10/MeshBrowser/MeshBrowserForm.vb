...
Namespace MeshBrowser
	...
	Partial Public Class MeshBrowserForm
        ...
        Private Sub InitMatrices()
            ...
            projectionMatrix = Camera.MatrixPerspectiveFovLH(CSng(Math.PI) * 0.25F, (CSng(Me.ClientSize.Width) / CSng(Me.ClientSize.Height)), 0.5F, 1000.0F)
        ...
        Protected Sub RenderScene()
            ...
            swapChain.TryPresent(1, PresentFlag.Default, [error])
        End Sub
        #End Region
