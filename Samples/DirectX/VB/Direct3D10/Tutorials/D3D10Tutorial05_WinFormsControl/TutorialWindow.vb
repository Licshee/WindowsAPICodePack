	...
	Partial Public Class TutorialWindow
		...
		Protected Sub RenderScene()
			If needsResizing Then
				...
				swapChain.ResizeBuffers(sd.BufferCount, CUInt(directControl.ClientSize.Width), CUInt(directControl.ClientSize.Height), sd.BufferDescription.Format, sd.Flags)
				SetViews()
