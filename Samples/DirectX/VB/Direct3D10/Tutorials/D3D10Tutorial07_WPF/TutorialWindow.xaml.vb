...
#Region "InitDevice()"
        ...
        Protected Sub InitDevice()
            device = D3DDevice1.CreateDeviceAndSwapChain1(host.Handle, swapChain)
...
#Region "RenderScene"
        ...
        Protected Sub RenderScene()
            If (needsResizing) Then
                ...
                swapChain.ResizeBuffers(sd.BufferCount, CUInt(host.ActualWidth), CUInt(host.ActualHeight), sd.BufferDescription.Format, sd.Flags)
                SetViews()
                InitMatrices()
            End If
