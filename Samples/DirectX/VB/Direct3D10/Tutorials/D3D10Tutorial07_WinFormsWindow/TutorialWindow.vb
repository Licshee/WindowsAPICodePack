	...
	Partial Public Class TutorialWindow
		...
		Protected Overrides Sub OnSizeChanged(ByVal e As EventArgs)
			If active Then
				...
				swapChain.ResizeBuffers(sd.BufferCount, CUInt(ClientSize.Width), CUInt(ClientSize.Height), sd.BufferDescription.Format, sd.Flags)
				SetViews()
		...
		Protected Sub InitDevice()
			device = D3DDevice.CreateDeviceAndSwapChain(Me.Handle, swapChain)
