...
namespace Microsoft.WindowsAPICodePack.Samples
{
    public partial class ExplorerBrowserTestForm : Form
    {
        ...
        public ExplorerBrowserTestForm()
        {
            ...
            explorerBrowser.NavigationPending += new ExplorerBrowserNavigationPendingEventHandler( explorerBrowser_NavigationPending );
            explorerBrowser.NavigationFailed += new ExplorerBrowserNavigationFailedEventHandler( explorerBrowser_NavigationFailed );
            explorerBrowser.NavigationComplete += new ExplorerBrowserNavigationCompleteEventHandler( explorerBrowser_NavigationComplete );
            explorerBrowser.ItemsChanged += new ExplorerBrowserItemsChangedEventHandler( explorerBrowser_ItemsChanged );
            explorerBrowser.SelectionChanged += new ExplorerBrowserSelectionChangedEventHandler( explorerBrowser_SelectionChanged );
            explorerBrowser.ViewEnumerationComplete += new ExplorerBrowserViewEnumerationCompleteHandler( explorerBrowser_ViewEnumerationComplete );
