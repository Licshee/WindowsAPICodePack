...
namespace Microsoft.WindowsAPICodePack.Samples
{
    ...
    public partial class ExplorerBrowserTestWindow : Window
    {
        ...
        {
            // bypass dependency properties to maintain bindings in XAML
            eb.ExplorerBrowserControl.NavigationOptions.PaneVisibility.Navigation = PaneVisibilityState.Show;
            eb.ExplorerBrowserControl.NavigationOptions.PaneVisibility.Preview = PaneVisibilityState.Show;
            eb.ExplorerBrowserControl.NavigationOptions.PaneVisibility.Details = PaneVisibilityState.Show;
            eb.ExplorerBrowserControl.NavigationOptions.PaneVisibility.Commands = PaneVisibilityState.Show;
        ...
        private void navigateFolderButton_Click( object sender, RoutedEventArgs e )
        {
            try
            {
                FileSystemFolder sf = FileSystemFolder.FromFolderPath(navigateFolderTextBox.Text);
                eb.ExplorerBrowserControl.Navigate( sf );
            }
            catch
            {
    ...
    public class TriCheckToPaneVisibilityState : IValueConverter
    {
        ...
        {
            if( value == null )
                return PaneVisibilityState.DontCare;
        ...
        {
            if( (PaneVisibilityState)value == PaneVisibilityState.DontCare )
                return null;
