	...
	Partial Public Class Window1
		...
		Private Sub GetPowerSettings()
			...
			If PowerManager.IsBatteryPresent Then
				...
				Dim batteryStateStr As String = String.Format("ACOnline: {1}{0}Max Charge: {2} mWh{0}Current Charge: {3} mWh{0}Discharge Rate: {4} {0}Estimated Time Remaining: {5}{0}Suggested Critical Battery Charge: {6} mWh{0}Suggested Battery Warning Charge: {7} mWh{0}", Environment.NewLine, batteryState.ACOnline, batteryState.MaxCharge, batteryState.CurrentCharge,If(batteryState.ACOnline = True, "N/A", batteryState.DischargeRate.ToString() & " mWh"),If(batteryState.ACOnline = True, "N/A", batteryState.EstimatedTimeRemaining.ToString()), batteryState.SuggestedCriticalBatteryCharge, batteryState.SuggestedBatteryWarningCharge)
