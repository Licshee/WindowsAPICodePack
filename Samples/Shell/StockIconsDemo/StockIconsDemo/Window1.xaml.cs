...
namespace StockIconsDemo
{
    ...
    public partial class Window1 : Window
    {
        ...
        private void UpdateStockIcon(StockIconSizes newSize, bool? linkOverlay, bool? selected)
        {
            ...
            //
            bool isLinkOverlay = (linkOverlay == true);
            bool isSelected = (selected == true);
        ...
        private void UpdateStockIconSettings(StockIconSizes newSize, bool isLinkOverlay, bool isSelected)
        {
        ...
        {
            UpdateStockIcon((StockIconSizes)comboBox1.SelectedIndex, linkOverlayCheckBox.IsChecked, selectedCheckBox.IsChecked);
        }
