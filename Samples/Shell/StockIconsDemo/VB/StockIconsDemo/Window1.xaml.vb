...
Namespace StockIconsDemo
	...
	Partial Public Class Window1
		...
		Private Sub UpdateStockIcon(ByVal newSize As StockIconSizes, ByVal linkOverlay? As Boolean, ByVal selected? As Boolean)
		...
		Private Sub UpdateStockIconSettings(ByVal newSize As StockIconSizes, ByVal isLinkOverlay As Boolean, ByVal isSelected As Boolean)
		...
		Private Sub linkOverlayCheckBox_Checked(ByVal sender As Object, ByVal e As RoutedEventArgs)
			UpdateStockIcon(CType(comboBox1.SelectedIndex, StockIconSizes), linkOverlayCheckBox.IsChecked, selectedCheckBox.IsChecked)
		End Sub
