...
Namespace Microsoft.WindowsAPICodePack.Samples.TabbedThumbnailDemo
    Partial Public Class Form1
        ...
        Private Sub button1_Click(ByVal sender As Object, ByVal args As System.EventArgs) Handles button1.Click
            Dim newTab As New TabPage("Tab " & tabControl1.TabPages.Count + 1)
        ...
        Private Sub preview_TabbedThumbnailClosed(ByVal sender As Object, ByVal e As TabbedThumbnailEventArgs)
            ...
            RemoveHandler e.TabbedThumbnail.TabbedThumbnailActivated, AddressOf preview_TabbedThumbnailActivated
            RemoveHandler e.TabbedThumbnail.TabbedThumbnailClosed, AddressOf preview_TabbedThumbnailClosed
            RemoveHandler e.TabbedThumbnail.TabbedThumbnailMaximized, AddressOf preview_TabbedThumbnailMaximized
            RemoveHandler e.TabbedThumbnail.TabbedThumbnailMinimized, AddressOf preview_TabbedThumbnailMinimized
