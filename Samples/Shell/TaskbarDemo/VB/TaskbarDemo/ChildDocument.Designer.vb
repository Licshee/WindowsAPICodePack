...
Namespace TaskbarDemo
	Partial Public Class ChildDocument
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(ChildDocument))
...
'			Me.pictureIconOverlay1.Click += New System.EventHandler(Me.pictureIconOverlay1_Click)
			...
			' 
			Me.buttonUserTasksAddTasks.Location = New System.Drawing.Point(143, 144)
			Me.buttonUserTasksAddTasks.Name = "buttonUserTasksAddTasks"
			Me.buttonUserTasksAddTasks.Size = New System.Drawing.Size(123, 23)
			Me.buttonUserTasksAddTasks.TabIndex = 12
			Me.buttonUserTasksAddTasks.Text = "Add Selected Tasks"
			Me.buttonUserTasksAddTasks.UseVisualStyleBackColor = True
'			Me.buttonUserTasksAddTasks.Click += New System.EventHandler(Me.buttonUserTasksAddTasks_Click_1)
			' 
			' listBox1
			' 
			...
			Me.buttonRefreshTaskbarList.Location = New System.Drawing.Point(178, 445)
