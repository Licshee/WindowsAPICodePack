...
namespace Microsoft.WindowsAPICodePack
{
    ...
    public class TaskDialog : IDialogControlHost, IDisposable
    {
        ...
        /// <summary>
        /// Expansion mode for this dialog
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the marquee style on the progress bar
        /// </summary>
        ...
        /// <summary>
        /// Creates a basic Win32 TaskDialog window 
        /// </summary>
        public TaskDialog()
        {
        ...
        private TaskDialogResult ConstructDialogResult(NativeTaskDialog native)
        {
            ...
            if (radioButtons.Count > 0 && native.SelectedRadioButtonID != TaskDialogNativeMethods.NO_DEFAULT_BUTTON_SPECIFIED)
            {
        ...
        private void ApplyGeneralNativeConfiguration(TaskDialogNativeMethods.TASKDIALOGCONFIG dialogConfig)
        {
            ...
            if (currentOwner == null)
                currentOwner = CoreHelpers.GetDefaultOwnerWindow();
            ...
            dialogConfig.MainIcon =
                new TaskDialogNativeMethods.TASKDIALOGCONFIG_ICON_UNION((int)mainIcon);
