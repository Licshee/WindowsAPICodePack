    ...
    public class TaskDialogProgressBar : TaskDialogBar
    {
        ...
        public int Value
        {
            ...
            set 
            {
                ...
                // Check for positive numbers
                if (value < Minimum)
                    throw new System.ArgumentException("Value value provided must be greater than or equal to minimum value", "value");
                if (value > Maximum)
                    throw new System.ArgumentException("Value value provided must be less than or equal to the maximum value", "value");
                this.value = value;
