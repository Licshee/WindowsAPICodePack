...
using namespace System;
    ...
    internal:
        ...
        {
            nativeUnknown.Set(pNativeID3D11Buffer);
        }

        D3DBuffer(ID3D11Buffer* pNativeID3D11Buffer, bool deletable)
        {
            nativeUnknown.Set(pNativeID3D11Buffer, deletable);
        }

        property ID3D11Buffer* NativeID3D11Buffer
        {
            ID3D11Buffer* get()
            {
                return reinterpret_cast<ID3D11Buffer*>(nativeUnknown.Get());
            }
        }
    };
} } } }
