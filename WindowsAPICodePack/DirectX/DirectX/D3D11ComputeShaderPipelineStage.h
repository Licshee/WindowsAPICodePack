...
public:
    ...
    Collection<D3DBuffer^>^ GetConstantBuffers(UInt32 startSlot, UInt32 numBuffers);
    ...
    Collection<SamplerState^>^ GetSamplers(UInt32 startSlot, UInt32 numSamplers);
    ...
    ComputeShader^ GetShader(UInt32 numClassInstances, [Runtime::InteropServices::Out] Collection<ClassInstance^>^ %outClassInstances);
    ...
    Collection<ShaderResourceView^>^ GetShaderResources(UInt32 startSlot, UInt32 numViews);
    ...
    Collection<UnorderedAccessView^>^ GetUnorderedAccessViews(UInt32 startSlot, UInt32 numUAVs);
