...
using namespace System;
    ...
    internal:
        ...
        {
            nativeUnknown.Set(pNativeID3D11DepthStencilState);
        }

        property ID3D11DepthStencilState* NativeID3D11DepthStencilState
        {
            ID3D11DepthStencilState* get()
            {
                return reinterpret_cast<ID3D11DepthStencilState*>(nativeUnknown.Get());
            }
        }
    };
} } } }
