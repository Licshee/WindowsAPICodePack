...
using namespace System;
    ...
    internal:
        ...
        {
            nativeUnknown.Set(pNativeID3D11RasterizerState);
        }

        property ID3D11RasterizerState* NativeID3D11RasterizerState
        {
            ID3D11RasterizerState* get()
            {
                return reinterpret_cast<ID3D11RasterizerState*>(nativeUnknown.Get());
            }
        }
    };
} } } }
