...
using namespace System;
    ...
    internal:
        ...
        {
            nativeUnknown.Set(pNativeID3D11SwitchToRef);
        }

        property ID3D11SwitchToRef* NativeID3D11SwitchToRef
        {
            ID3D11SwitchToRef* get()
            {
                return reinterpret_cast<ID3D11SwitchToRef*>(nativeUnknown.Get());
            }
        }
    };
} } } }
