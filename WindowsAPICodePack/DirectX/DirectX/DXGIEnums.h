...
public enum class PresentFlag 
{
    ...
    /// </summary>
    DoNotRestarte = DXGI_PRESENT_RESTART,
    /// <summary>
...
public enum class AdapterFlag 
{
    ...
    /// <para>(Also see DirectX SDK: DXGI_ADAPTER_FLAG_FORCE_DWORD)</para>
    /// </summary>
    ForceDword = DXGI_ADAPTER_FLAG_FORCE_DWORD,
};
/// <summary>
...
public enum class Format 
{
    ...
    /// <summary>
    /// Forces this enumeration to compile to 32 bits in size. Without this value, some compilers would allow this enumeration to compile to a         size other than 32 bits. This value is not used.
    /// <para>(Also see DirectX SDK: DXGI_FORMAT_FORCE_UINT)</para>
    /// </summary>
...
/// <summary>
/// DirectX Supported Interfaces
/// </summary>
[Flags]
public enum class MakeWindowAssociationFlags
{
    /// <summary>
