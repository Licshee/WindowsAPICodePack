...
using namespace System;
    ...
    public: 
        ...
        /// </summary>
        property ResourceHandle^ SharedHandle        
        {
            ResourceHandle^ get();
        }
    ...
    internal:
        ...
        {
            nativeUnknown.Set(pNativeIDXGIResource);
        }

        property IDXGIResource* NativeIDXGIResource
        {
            IDXGIResource* get()
            {
                return reinterpret_cast<IDXGIResource*>(nativeUnknown.Get());
            }
        }
    };
} } } }
