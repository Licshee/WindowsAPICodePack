    ...
    abstract public class ShellFileSystemObject : ShellObject
    {
        ...
        public PropertyCollection Properties
        {
            get
            {
                ...
                {
                    properties = new PropertyCollection(NativeShellItem2);
                }
                return properties;
            }
        }

        private ShellObjectThumbnail thumbnail;
        /// <summary>
        /// Gets the thumbnail of the ShellFileSystemObject object.
        /// </summary>
        public ShellObjectThumbnail Thumbnail
        {
            get
            {
                if (thumbnail == null)
                    thumbnail = new ShellObjectThumbnail(NativeShellItem);
