...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    /// </summary>
    public class ExplorerBrowser : System.Windows.Forms.Control, Microsoft.WindowsAPICodePack.Shell.IServiceProvider, IExplorerPaneVisibility, IExplorerBrowserEvents, ICommDlgBrowser
    {
        #region properties
        /// <summary>
        /// Options that control how the ExplorerBrowser navigates
        /// </summary>
        public readonly ExplorerBrowserNavigationOptions NavigationOptions;
        ...
        /// </summary>
        public readonly ExplorerBrowserNavigationLog NavigationLog;
        ...
        public event ExplorerBrowserSelectionChangedEvent SelectionChanged;

        /// <summary>
        /// Fires when the Items colection changes. 
        /// </summary>
        /// <remarks>Arrives on a non-UI thread</remarks>
        public event ExplorerBrowserItemsChangedEvent ItemsChanged;
        
        /// <summary>
        /// Fires when a navigation has been initiated, but is not yet complete.
        /// </summary>
        /// <remarks>Arrives on a non-UI thread</remarks>
        public event ExplorerBrowserNavigationPendingEvent NavigationPending;
        ...
        /// </summary>
        /// <remarks>Arrives on a non-UI thread</remarks>
        public event ExplorerBrowserNavigationCompleteEvent NavigationComplete;
        ...
        /// </summary>
        /// <remarks>Arrives on a non-UI thread</remarks>
        public event ExplorerBrowserNavigationFailedEvent NavigationFailed;
        ...
        protected override void OnCreateControl( )
        {
            ...
            if( this.DesignMode == false )
            {
                ...
                NavigationOptions.AlwaysNavigate = true;
        ...
        HRESULT IExplorerBrowserEvents.OnNavigationPending( IntPtr pidlFolder )
        {
            ...
            {
                NavigationPendingArgs args = new NavigationPendingArgs( );
        ...
        HRESULT IExplorerBrowserEvents.OnNavigationComplete( IntPtr pidlFolder )
        {
            ...
            {
                NavigationCompleteArgs args = new NavigationCompleteArgs( );
        ...
        HRESULT IExplorerBrowserEvents.OnNavigationFailed( IntPtr pidlFolder )
        {
            ...
            {
                NavigationFailedArgs args = new NavigationFailedArgs( );
        ...
        /// <summary>
        /// Gets the IFolderView of the ExplorerBrowser control
        /// </summary>
        /// <returns></returns>
        internal IFolderView GetFolderView( )
        {
            ...
            return (IFolderView)Marshal.GetObjectForIUnknown(view);
        }
