...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class ExplorerBrowserNavigationLog
    {
        ...
        /// The navigation log
        /// </summary>
        public readonly List<ShellObject> Locations = new List<ShellObject>();
        ...
        /// </summary>
        public event NavigationLogChangedEvent NavigationLogChanged;
        #endregion
        ...
        internal ExplorerBrowserNavigationLog( ExplorerBrowser parent )
        {
            ...
            this.parent = parent;
            this.parent.NavigationComplete += new ExplorerBrowserNavigationCompleteEvent( OnNavigationComplete );
            this.parent.NavigationFailed += new ExplorerBrowserNavigationFailedEvent( OnNavigationFailed );
        }

        private void OnNavigationFailed( object sender, NavigationFailedArgs args )
        {
            pendingNavigation = null;
        }

        private void OnNavigationComplete( object sender, NavigationCompleteArgs args )
        {
