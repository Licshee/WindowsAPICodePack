...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class Property<T> : IProperty
    {
        ...
        private const int INPLACE_S_TRUNCATED = 0x00401A0;
        ...
        private void GetImageRefernece()
        {
            ...
            IPropertyStore store = PropertyCollection.CreateDefaultPropertyStore(ParentShellObject);
        ...
        private void StorePropVariantValue(PropVariant propVar)
        {
            ...
            try
            {
                ...
                if (!AllowTruncatedValue && (result == INPLACE_S_TRUNCATED))
                {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown if is <see cref="AllowTruncatedValue"/> false, and
        ...
        /// </summary>
        public bool AllowTruncatedValue
        {
            get;
            set;
        }
