...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class PropertyCollection : ReadOnlyCollection<IProperty>
    {
        ...
        internal PropertyCollection(ShellObject parent)
        ...
        private IProperty CreateTypedProperty(PropertyKey propKey)
        {
            ...
            switch (desc.VarEnumType)
            {
                ...
                case (VarEnum.VT_NULL):
                    {
                        return (new Property<Object>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_UI1):
                    {
                        return (new Property<Byte?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_I2):
                    {
                        return (new Property<Int16?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_UI2):
                    {
                        return (new Property<UInt16?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_I4):
                    {
                        return (new Property<Int32?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_UI4):
                    {
                        return (new Property<UInt32?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_I8):
                    {
                        return (new Property<Int64?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_UI8):
                    {
                        return (new Property<UInt64?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_R8):
                    {
                        return (new Property<Double?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_BOOL):
                    {
                        return (new Property<Boolean?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_FILETIME):
                    {
                        return (new Property<DateTime?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_CLSID):
                    {
                        return (new Property<IntPtr?>(propKey, desc, ParentShellObject));
                    }
                case (VarEnum.VT_CF):
                    {
                        return (new Property<IntPtr?>(propKey, desc, ParentShellObject));
                ...
                case (VarEnum.VT_LPWSTR):
                    {
                        return (new Property<String>(propKey, desc, ParentShellObject));
                    }
                ...
                case (VarEnum.VT_STREAM):
                    {
                        return (new Property<IStream>(propKey, desc, ParentShellObject));
                    }
