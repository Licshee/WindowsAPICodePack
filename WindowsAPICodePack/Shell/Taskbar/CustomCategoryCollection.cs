...
namespace Microsoft.WindowsAPICodePack.Shell.Taskbar
{
    ...
    public class CustomCategoryCollection
        : ICollection<CustomCategory>, INotifyCollectionChanged
    {
        private List<CustomCategory> categories = new List<CustomCategory>();
        ...
        public void Add(CustomCategory category)
        {
        ...
        public bool Remove(CustomCategory category)
        {
        ...
        public bool Contains(CustomCategory category)
        {
        ...
        public void CopyTo(CustomCategory[] array, int index)
        {
        ...
        /// </summary>
        /// <returns>Enumerator to iterate through this collection.</returns>
        IEnumerator<CustomCategory> IEnumerable<CustomCategory>.GetEnumerator()
        {
            return categories.GetEnumerator();
        }
    }
