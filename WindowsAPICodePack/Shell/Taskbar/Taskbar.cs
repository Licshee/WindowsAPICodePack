...
namespace Microsoft.WindowsAPICodePack.Shell.Taskbar
{
    ...
    public static class Taskbar
    {
        ...
        private static MultiViewProgressBar multiViewprogressBar;
        /// <summary>
        ...
        /// </summary>
        public static MultiViewProgressBar MultiViewprogressBar
        {
            get
            {
                if (multiViewprogressBar == null)
                {
                    lock (syncLock)
                    {
                        if (multiViewprogressBar == null)
                            multiViewprogressBar = new MultiViewProgressBar();
                    }
                }

                return multiViewprogressBar;
            }
        }
